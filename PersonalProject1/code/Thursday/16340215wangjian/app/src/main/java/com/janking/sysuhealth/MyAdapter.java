...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void initData()
    {
        ...
        mDatas.add(new Food("下面为了测试动画:","蔬菜","番茄红素","#4469B0"));
        mDatas.add(new Food("TEST1","蔬菜","番茄红素","#4469B0"));
        mDatas.add(new Food("TEST2","蔬菜","胡萝卜素", "#20A17B"));
        mDatas.add(new Food("TEST3","蔬菜","膳食纤维", "#BB4C3B"));
        mDatas.add(new Food("TEST4","杂","几乎包含所有营养物质", "#C48D30"));
        mDatas.add(new Food("TEST5","蔬菜","番茄红素","#4469B0"));
        mDatas.add(new Food("TEST6","蔬菜","胡萝卜素", "#20A17B"));
        mDatas.add(new Food("TEST7","蔬菜","膳食纤维", "#BB4C3B"));
        mDatas.add(new Food("TEST8","杂","几乎包含所有营养物质", "#C48D30"));
    }
