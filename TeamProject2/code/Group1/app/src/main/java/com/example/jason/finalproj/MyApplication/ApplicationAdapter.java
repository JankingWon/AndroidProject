...
public class ApplicationAdapter extends RecyclerView.Adapter<ApplicationAdapter.ViewHolder> {
    ...
    private ApplicationAdapter.OnItemClickListener mOnItemClickListener = null;

    public ApplicationAdapter (Context context, int layoutid, List<Map<String, Object>> datas , List<Map<String, Bitmap>> images) {
        mContext = context;
        mLayoutid = layoutid;
        mData = datas;
        mImage = images;
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
            mtype = (TextView) itemView.findViewById(R.id.application_item_type);
            mphoto = (CircleImageView) itemView.findViewById(R.id.application_item_photo);
            mname = (TextView) itemView.findViewById(R.id.application_item_name);
            mbadge = (ImageView) itemView.findViewById(R.id.application_item_badge);
            mdate = (TextView) itemView.findViewById(R.id.application_item_date);
            mtitle = (TextView) itemView.findViewById(R.id.application_item_title);
            mbody = (TextView) itemView.findViewById(R.id.application_item_body);
            mstate = (ImageView) itemView.findViewById(R.id.application_item_state);
        }
        public static ApplicationAdapter.ViewHolder get(Context context, ViewGroup parent, int layoutId) {
            View itemView = LayoutInflater.from(context).inflate(layoutId, parent, false);
            ApplicationAdapter.ViewHolder holder = new ApplicationAdapter.ViewHolder(itemView);
            return holder;
        }
    }
    ...
    @Override
    public ApplicationAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent, int ViewType) {
        ApplicationAdapter.ViewHolder viewHolder = ApplicationAdapter.ViewHolder.get(mContext, parent, mLayoutid);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ApplicationAdapter.ViewHolder holder, int position) {
        //类型
